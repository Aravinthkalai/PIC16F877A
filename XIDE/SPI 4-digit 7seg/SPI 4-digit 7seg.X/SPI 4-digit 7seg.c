...
{
    SPI_init();
    SPI_Write(ar2[0],arr[0]);
    SPI_Write(ar2[1],arr[1]);
    SPI_Write(ar2[2],arr[2]);
    SPI_Write(ar2[3],arr[3]);
    SPI_Write(ar2[4],arr[4]);
    SPI_Write(ar2[5],arr[5]);
    SPI_Write(ar2[6],arr[6]);
    SPI_Write(ar2[7],arr[7]);
    while(1)
    {
